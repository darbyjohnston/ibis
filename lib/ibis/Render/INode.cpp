...
namespace ibis
{
    namespace render
    {
        ...
        ftk::gl::TextureInfo INode::getOutputInfo(int index) const
        {
            return _outputInfo->getItem(index);
        }

        std::shared_ptr<ftk::IObservableList<ftk::gl::TextureInfo> > INode::observeOutputInfo() const
        {
            return _outputInfo;
        }

...
namespace ibis
{
    namespace render
    {
        ...
        {
            INode::_init(context, info, inputCount, outputCount, attr, json);
        }
        ...
        void InvertNode::_init(
            const std::shared_ptr<ftk::Context>& context,
            const nlohmann::json& json)
        {
            INode::_init(context, getClassNodeInfo(), 1, 1, {}, json);
        }

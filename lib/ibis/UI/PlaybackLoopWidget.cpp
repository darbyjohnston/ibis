    ...
    namespace ui
    {
        namespace
        {
            ...
            private:
                ...
                std::function<void(models::PlaybackLoop)> _callback;
            };
                ...
                const std::shared_ptr<IWidget>& parent)
            {
                ...
                _buttonGroup->setCheckedCallback(
                    [this](int index, bool value)
                    {
                        if (value && _callback)
                        {
                            _callback(static_cast<models::PlaybackLoop>(index));
                        }
                        close();
                    });
            }
            ...
            void PlaybackLoopPopup::setLoop(models::PlaybackLoop value)
            {
                _buttonGroup->setChecked(static_cast<int>(value));
            }

            void PlaybackLoopPopup::setCallback(const std::function<void(models::PlaybackLoop)>& value)
            {
                _callback = value;
            }
        }
        ...
        {
            models::PlaybackLoop loop = models::PlaybackLoop::Loop;

            std::shared_ptr<ftk::ToolButton> button;
            std::shared_ptr<PlaybackLoopPopup> popup;

            std::function<void(models::PlaybackLoop)> callback;
        };
        ...
        models::PlaybackLoop PlaybackLoopWidget::getLoop() const
        {
            return _p->loop;
        }

        void PlaybackLoopWidget::setLoop(models::PlaybackLoop value)
        {
            FTK_P();
            if (value == p.loop)
                return;
        ...
        void PlaybackLoopWidget::setCallback(const std::function<void(models::PlaybackLoop)>& value)
        {
            _p->callback = value;
        }
        ...
        void PlaybackLoopWidget::_widgetUpdate()
        {
            ...
            switch (p.loop)
            {
            case models::PlaybackLoop::Loop: icon = "PlaybackLoop"; break;
            case models::PlaybackLoop::Once: icon = "PlaybackOnce"; break;
            case models::PlaybackLoop::PingPong: icon = "PlaybackPingPong"; break;
            default: break;
            }
        ...
        void PlaybackLoopWidget::_showPopup()
        {
            ...
            if (context && window)
            {
                if (!p.popup)
                {
                    ...
                    p.popup->setCallback(
                        [weak](models::PlaybackLoop value)
                        {
